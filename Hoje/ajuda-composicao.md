...
Use este arquivo quando travar em alguma parte da teoria.

- `teoria-composicao.pdf` é o documento principal. Leia ele primeiro.
- `teoria-composicao.md` é o mesmo texto, em Markdown, para editar.
- Este arquivo explica os pontos difíceis outra vez, com palavras mais simples.
...
Depois, faça os exercícios do `exercicios-composicao.pdf`, nesta mesma pasta.
